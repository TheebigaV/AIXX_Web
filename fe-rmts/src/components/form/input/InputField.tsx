...
interface InputProps {
  ...
  type?: "text" | "number" | "email" | "password" | "date" | "time" | "submit" | string;
  id?: string;
  name?: string;
  value?: string | number; // Controlled value
  defaultValue?: string | number; // Uncontrolled value
  placeholder?: string;
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        id={id}
        name={name}
        value={value} // Controlled input if provided
        defaultValue={value === undefined ? defaultValue : undefined} // Fallback to uncontrolled
