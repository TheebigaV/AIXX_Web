    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                ...
                'is_active' => true,
                'image' => 'https://via.placeholder.com/150?text=Quantum',
            ],
            [
                'name' => 'Cyber security',
            ...
            [
                ...
                'is_active' => true,
                'image' => 'https://via.placeholder.com/150?text=Ecommerce',
            ],
            [
                ...
                'is_active' => true,
                'image' => 'https://via.placeholder.com/150?text=Autonomous',
            ],
            [
                ...
                'is_active' => true,
                'image' => 'https://via.placeholder.com/150?text=Decision',
            ],
            [
                ...
                'is_active' => true,
                'image' => 'https://via.placeholder.com/150?text=Logistics',
            ],
            [
                ...
                'is_active' => true,
                'image' => 'https://via.placeholder.com/150?text=AI+Quantum',
            ],
        ];
